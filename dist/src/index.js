...
const { Canvas, Image, ImageData } = commons_1.canvas;
...
function matchRostros(objAlbumDatos) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const canFotoSemilla = yield commons_1.canvas.loadImage(rutFotoSemilla);
        const resultsQuery = yield faceapi.detectAllFaces(canFotoSemilla, commons_1.faceDetectionOptions);
        // tslint:disable-next-line:no-console
